...
| [turning-git-into-an-application-database](https://nede.dev/blog/turning-git-into-an-application-database)  | `git`    | 2/2/2024 | 作者用 git 作为带有版本管理功能存储, 做了一个简单的应用, 基于文件目录做 CRUD     |  文章没有提到 git 原理, demo 很简单, 性能也比较一般, 只能算是一个 proof of concept |
